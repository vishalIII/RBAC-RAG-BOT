...
function sendValidationError(res: Response, message: string, statusCode: number = 400): void {
...
export class EmployeeController {
  static async create(req: Request, res: Response): Promise<void> {
    try {
      ...
      const result = await EmployeeService.create(tenantId, companyId, userId, employeeData);
  ...
  static async getAll(req: Request, res: Response): Promise<void> {
    try {
      ...
      const employees = await EmployeeService.getAll(tenantId, companyId);
  ...
  static async getById(req: Request, res: Response): Promise<void> {
    try {
      ...
      const employee = await EmployeeService.getById(tenantId, companyId, id);
  ...
  static async update(req: Request, res: Response): Promise<void> {
    try {
      ...
      const employee = await EmployeeService.update(tenantId, companyId, id, updateData);
  ...
  static async delete(req: Request, res: Response): Promise<void> {
    try {
      ...
      await EmployeeService.delete(tenantId, companyId, id);
