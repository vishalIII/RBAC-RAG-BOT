...
export class DocumentService {
    static async create(companyId, uploadedBy, metadata, file) {
      ...
      `, [
        ...
        `, [document.id, departmentId]);
            ...
            await IngestionService.ingestDocument(document.file_path, // 1. filePath
    ...
    static async updateDocument(companyId, id, data, file) {
    ...
    `, [
        ...
        if (data.department_ids) {
            await pool.query("DELETE FROM document_departments WHERE document_id = $1", [id]);
        ...
        const metadataChanged = data.title !== undefined ||
    ...
    `, [id]);
        ...
        try {
            ...
            await IngestionService.ingestDocument(updatedDoc.file_path, updatedDoc.title, updatedDoc.document_type, updatedDoc.tags || [], departmentIds, companyId, updatedDoc.uploaded_by, updatedDoc.created_at.toISOString(), updatedDoc.id);
